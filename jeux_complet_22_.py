...
class JeuJcJ:
    def __init__(self):
        ...
        self.particle_manager = ParticleManager()  # Initialiser le gestionnaire de particules

    # ... (Autres méthodes de JeuJcJ)
    ...
    def draw_game_state(self, screen, game_state, valid_moves, selected_square):
        ...
        self.particle_manager.draw(screen)  # Dessiner les particulesselected_square)
            ...
            if game_over:
                if game_state.checkmate:
                    ...
                    if game_state.white_to_move:
                        ...
                        text_rect = text_surface.get_rect()
                        text_rect.center = (900 // 2, 550)  # Positionnez le texte sous l'image de victoire
                        screen.blit(text_surface, text_rect)
                    ...
                    for _ in range(1000):  # Nombre de particules à ajouter
                        x = random.randint(0, self.WIDTH)
                        y = random.randint(0, self.HEIGHT)
                        self.particle_manager.add_particle(x, y)
