...
class ChessApp:
    def __init__(self):
        ...
        self.dragging = False
        self.drag_offset = (0, 0)  # Offset from the top-left corner of the piece to the mouse position
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.button == 1:
                        ...
                        if 0 <= row < 8 and 0 <= col < 8:
                            ...
                            self.dragging = True
                            self.drag_offset = (mouse_pos[0] - self.selected_piece_rect.x, mouse_pos[1] - self.selected_piece_rect.y)
                elif event.type == pygame.MOUSEBUTTONUP:
                    if event.button == 1:
                        self.dragging = False
                        self.selected_square = None  # Reset selected square after dropping the piece
            ...
            for col in range(8):
                ...
                if piece_name:
                    ...
                    if (row, col) == selected_square:
                        ...
                        self.selected_piece_rect = piece_rect  # Store the selected piece rect
