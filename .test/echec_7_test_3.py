...
class ChessApp:
    def __init__(self):
        ...
        self.board = ChessboardWidget(self.font)
    ...
    def run(self):
        ...
        while running:
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.button == 1:
                        ...
                        if 0 <= row < 8 and 0 <= col < 8:
                            # Inside the MOUSEBUTTONDOWN event block
                            ...
                            if self.selected_piece:
                                ...
                                self.selected_piece_rect = self.board.get_piece_rect(row, col)  # Update selected piece rect here
                                self.dragging = True
                                self.drag_offset = (mouse_pos[0] - self.selected_piece_rect.topleft[0], mouse_pos[1] - self.selected_piece_rect.topleft[1])
                            else:
                                self.help_text = "No piece selected"
                            self.dragging = True
                            self.drag_offset = (mouse_pos[0] - self.selected_piece_rect.topleft[0], mouse_pos[1] - self.selected_piece_rect.topleft[1]) if self.selected_piece_rect else (0, 0)
            ...
            if self.dragging:
                mouse_pos = pygame.mouse.get_pos()
                if self.selected_piece_rect:
                    self.selected_piece_rect.topleft = (mouse_pos[0] - self.drag_offset[0], mouse_pos[1] - self.drag_offset[1])
    ...
    def display_image(self):
        image_path = "images/assets/logo2.png"
