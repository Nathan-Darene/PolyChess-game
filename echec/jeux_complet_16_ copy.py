            ...
            if move_made:
                ...
                if game_state.checkmate:
                    ...
                    if game_state.white_to_move:
                        image = pygame.image.load("images/victoire/fortnite-logo-transparent-symbol-2.png")
                        largeur_image=300
                        hauteur_image=280
                        image = pygame.transform.scale(image, (largeur_image, hauteur_image))  # Redimensionner l'image
                        image_rect = image.get_rect()
                        image_rect.center = (largeur // 2, hauteur // 3)  # Positionner l'image au centre de l'écran
