...
class JeuJcJ:
    def __init__(self):
        ...
        self.load_images()
        self.load_image()  # Ensure images are loaded when the instance is created
    ...
    def load_image(self):
        ...
        self.image_slatemate = pygame.image.load("images/victoire/fortnite-victory-royale-la-royale-png-file-8.png").convert_alpha()

        # Redimensionner les images à une taille plus petite
        self.image_checkmate = pygame.transform.scale(self.image_checkmate, (100, 100))
        self.image_slatemate = pygame.transform.scale(self.image_slatemate, (100, 100))
        ...
        while running:
            ...
            if move_made:
                ...
                if game_state.checkmate:
                    screen.blit(self.image_checkmate, (100, 100))  # Afficher l'image en cas d'échec et mat
                    game_over = True
                    if game_state.white_to_move:
                        print('Victoire des Noirs par ECHEC et MATE')  # Affiche un message correspondant à la victoire blanche
                    else:
                        print('Victoire des Blancs par ECHEC et MATE')

                elif game_state.stalemate:  # Nouvelle condition pour le stalemate
                    screen.blit(self.image_slatemate, (100, 100))  # Afficher l'image en cas de stalemate
                    print('Stalemate')
    ...
    def animate_move(self, move, screen, board, clock):
        ...
        for frame in range(frame_count + 1):
            ...
            if move.piece_captured != '--':
                ...
                pygame.mixer.Sound.play(son_selection_capture2)
