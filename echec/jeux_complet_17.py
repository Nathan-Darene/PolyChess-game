            ...
            if move_made:
                ...
                if game_state.checkmate:
                    ...
                    if game_state.white_to_move:
                        screen.blit(self.image_checkmate, (100, 100))  # Afficher l'image_true si la somme est paire
                    ...
                    screen.blit(self.image_slatemate, (100, 100))  # Afficher l'image_true si la somme est paire
                    print('Stalemate')
