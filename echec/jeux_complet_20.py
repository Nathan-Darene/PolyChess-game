            ...
            if game_over:
                if game_state.checkmate:
                    ...
                    if game_state.white_to_move:
                        text_surface = police_victoire.render("Victoire des Noirs par ECHEC et MATE", True, couleur)
                        ...
                        text_surface = police_victoire.render("Victoire des Blancs par ECHEC et MATE", True, couleur)
                        text_rect = text_surface.get_rect()
                ...
                pygame.display.flip()  # Mise à jour de l'écran pour afficher l'image de victoire ou de stalemate

                # Attendre que l'utilisateur ferme le jeu
                while game_over:
                    for event in pygame.event.get():
                        if event.type == pygame.QUIT:
                            running = False
