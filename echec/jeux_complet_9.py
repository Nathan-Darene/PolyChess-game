...
class Menu:
    ...
    def _afficher_titre(self):
        ...
        #position du texte
        first_surface_rect.center = (largeur // 2, 20) 
        titre_rect.center = (largeur // 2, 60)
        createur_rect.center = (largeur // 2, 150)
        auteur_rect.center = (largeur // 2, 230)
...
class EcranChargement:
    def __init__(self):
        ...
        self.video.set_duration(3)  # Définition la durée de la vidéo à 3 secondes
