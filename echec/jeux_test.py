...
class JeuJcJ:
    ...
    def load_victory_images(self):
        try:
            ...
            self.image_stalemate = pygame.transform.scale(self.image_stalemate, (100, 100))
        ...
        while running:
            ...
            if move_made:
                ...
                if game_state.checkmate:
                    ...
                    screen.blit(self.image_checkmate, (450, 450))  # Afficher l'image en cas d'échec et mat
                    pygame.display.flip()  # Mise à jour de l'écran pour afficher l'image
                    game_over = True
                    ...
                    self.draw_game_state(screen, game_state, valid_moves, selected_square)
                    screen.blit(self.image_stalemate, (100, 100))  # Afficher l'image en cas de stalemate
                    pygame.display.flip()  # Mise à jour de l'écran pour afficher l'image
                    print('Stalemate')
